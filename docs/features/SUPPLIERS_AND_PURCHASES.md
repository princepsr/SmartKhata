...
3. **Intelligent Tax Handling**:
   - **Auto-Detection**: Compares Supplier GSTIN and Shop GSTIN state codes to decide between **CGST/SGST** or **IGST**.
   - **Precision**: Quantities are rounded to **3 decimal places** (critical for weight-based purchases) before calculation.
   - **Financials**: Rounds final tax and grand totals to 2 decimal places to ensure ledger precision.
