...
├── product-repository.ts       # Product management
├── customer-repository.ts      # Customer management
├── bill-repository.ts          # Sales/Billing management
├── product-repository.ts       # Inventory management
├── settings-repository.ts      # App settings persistence
├── license-repository.ts       # License & Trial management
├── purchase-repository.ts      # Supplier purchases
├── supplier-repository.ts      # Supplier management
└── ... (15+ specialized repositories)
```
